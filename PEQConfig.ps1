<#
    ...
    --------------------------------------------------------------------------------
     ...
     Generated on:       1/26/2019 12:28 AM
     Generated by:       
    --------------------------------------------------------------------------------
    .DESCRIPTION
...
function Show-MainForm_psf
{
	...
	$quickSwitchToolStripMenuItem = New-Object 'System.Windows.Forms.ToolStripMenuItem'
...
"@
	...
	$buttonSaveAsDefaultLocatio_Click = {
		...
		$NewINIContent = @{ "Paths" = $ToonsLocation + $ShortcutsLocation + $EQBCSFileLocation }
...
do {
	...
	$buttonFlagCheck_Click={
		...
		$flags = (Get-Content $EQBCSFile.Text | Where-Object { $_ -match 'flag' }) | Select-Object -Unique
		Update-Display $flags -color 'Green'
		Update-Display "Character Count: $count" -color 'Yellow'
		buttonup
	}
	...
	$quickSwitchToolStripMenuItem_Click={
		$richtextbox1.Clear()
		Update-Display 'Allows quick switching of all running Everquest processes.  Special thanks to Glitter for the idea.' -color 'Orange'
	...
	$Form_Cleanup_FormClosed=
	{
		...
		try
		{
			...
			$quickSwitchToolStripMenuItem.remove_Click($quickSwitchToolStripMenuItem_Click)
...
TkSuQmCC')
	...
	$groupbox1.Controls.Add($buttonSaveAsDefaultLocatio)
	...
	# buttonBrowse2
	#
	$buttonBrowse2.Location = '294, 170'
	...
	# buttonBrowseFolder
	#
	$buttonBrowseFolder.Location = '294, 120'
	...
	$labelEQBCSLogFileLocation.Location = '13, 152'
	...
	#
	$buttonSaveAsDefaultLocatio.Location = '13, 197'
	...
	$ShortcutsFolder.Location = '12, 123'
	...
	$labelShortcutsFolderLocat.Location = '13, 106'
...
')
	#endregion
...
tQcE/he1KvPnPfHWFAAAAABJRU5ErkJggg==')
	...
	$labelToonsCsvLocation.Location = '12, 60'
	...
	#
	$buttonBuildSampleTOONSCSV.Location = '11, 318'
	...
	#
	$buttonBuildMQ2AutoLogin.Location = '199, 256'
	...
	#
	$buttonBuildShortcuts.Location = '11, 256'
	...
	#
	$buttonBuildAutoHotKey.Location = '105, 256'
	...
	[void]$helpToolStripMenuItem.DropDownItems.Add($quickSwitchToolStripMenuItem)
	...
	#
	$quickSwitchToolStripMenuItem.Name = 'quickSwitchToolStripMenuItem'
	$quickSwitchToolStripMenuItem.Size = '252, 22'
	$quickSwitchToolStripMenuItem.Text = 'Quick Switch'
	$quickSwitchToolStripMenuItem.add_Click($quickSwitchToolStripMenuItem_Click)

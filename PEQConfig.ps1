<#
    ...
    --------------------------------------------------------------------------------
     ...
     Generated on:       1/25/2019 7:43 PM
     Generated by:       
    --------------------------------------------------------------------------------
    .DESCRIPTION
...
function Show-MainForm_psf
{
	...
	$buttonblank = New-Object 'System.Windows.Forms.Button'
...
do {
	...
	$buttonblank_Click={
		buttondown
		$richtextbox1.Clear()
		Update-Display 'Place holder - nothing here yet.  Button bar is nice and symmetrical now.'  -color 'orange'
		buttonup
	}
	...
	$Form_Cleanup_FormClosed=
	{
		...
		try
		{
			...
			$buttonblank.remove_Click($buttonblank_Click)
...
TkSuQmCC')
	#endregion
	$button_outputClear.Location = '12, 715'
	...
	$buttonQuickSwitchRefresh.TabIndex = 0
	...
	$buttonSaveAsDefaultLocatio.TabIndex = 4
	$buttonSaveAsDefaultLocatio.Text = 'Save as Default Locations'
	$tooltip1.SetToolTip($buttonSaveAsDefaultLocatio, 'Save default locations to INI file where PEQ Config is located')
	...
	# tabpage1
	#
	$tabpage1.Controls.Add($buttonblank)
	...
	#
	#region Binary Data
	$buttonblank.Image = [System.Convert]::FromBase64String('
')
	#endregion
	$buttonblank.ImageAlign = 'TopCenter'
	$buttonblank.Location = '102, 28'
	$buttonblank.Name = 'buttonblank'
	$buttonblank.Size = '88, 81'
	$buttonblank.TabIndex = 1
	$buttonblank.Text = '<blank>'
	$buttonblank.TextAlign = 'BottomCenter'
	$buttonblank.UseCompatibleTextRendering = $True
	$buttonblank.UseVisualStyleBackColor = $True
	$buttonblank.add_Click($buttonblank_Click)
	#
	# textbox2
	#
...
tQcE/he1KvPnPfHWFAAAAABJRU5ErkJggg==')
	...
	#
	$buttonBuildSampleTOONSCSV.Location = '11, 300'

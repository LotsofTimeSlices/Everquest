<#
    ...
    --------------------------------------------------------------------------------
     ...
     Generated on:       3/8/2020 10:42 AM
...
function Show-MainForm_psf
{
	...
	$buttonStopMonitors = New-Object 'System.Windows.Forms.Button'
...
"@
	...
	$Form_Cleanup_FormClosed=
	{
		...
		try
		{
			...
			$buttonStopMonitors.remove_Click($buttonStopMonitors_Click)
	...
	$tabpage1.Controls.Add($buttonStopMonitors)
...
AAAOvwAADr8BOAVTJAAAAiFJREFUSEvtk9tLFGEYhz+VLgS1bdtSWzPLQx4qFpUkojUtO2zrbiG2
...
AAAAAElFTkSuQmCC')
	...
	# buttonStopMonitors
	#
	$buttonStopMonitors.Location = '17, 249'
	$buttonStopMonitors.Name = 'buttonStopMonitors'
	$buttonStopMonitors.Size = '178, 23'
	$buttonStopMonitors.TabIndex = 33
	$buttonStopMonitors.Text = 'Stop Monitors'
	$tooltip1.SetToolTip($buttonStopMonitors, 'Stops both disconnected and crash/hung monitors')
	$buttonStopMonitors.UseCompatibleTextRendering = $True
	$buttonStopMonitors.UseVisualStyleBackColor = $True
	$buttonStopMonitors.add_Click($buttonStopMonitors_Click)
	#
	# checkboxMakeASound
	#
...
')
	#endregion
...

TkSuQmCC')
	#endregion
...
iVBORw0KGgoAAAANSUhEUgAAABgAAAAYCAYAAADgdz34AAAABGdBTUEAALGPC/xhBQAAAAlwSFlz
AAAOvwAADr8BOAVTJAAABLZJREFUSEudlQ1MlWUUxx8naJhAuKKxmDIpCsFiY2Ntls2tuWyuWdTU
...
r45GQEorJM2PnkMgGiRVjUn39/p//xlK/QM6va9RgBfiogAAAABJRU5ErkJggg==')
	...
	$tooltip1.SetToolTip($buttonstartMissingToons, '(Legacy) Restarts missing toons listed in toons.csv')
...
o8bzvIb3P/Ht/0N4ePwJpSUb75z8rvAAAAAASUVORK5CYII=')
	...
	$tooltip1.SetToolTip($buttonEQMonitor, '(Legacy) Opens a separate, minimized PowerShell window and watches for hung processes')
...
qcYCeYIxsz1MFXa+O4T6uZA/PV8TQizgTT+1rKqn1V8wmX4B4QlJX+nAb7oAAAAASUVORK5CYII=')
	...
	$tooltip1.SetToolTip($buttonHungKickedProcesses, '(Legacy) Manually checks for hung EQ processes')
...
AAAAAElFTkSuQmCC')
	...
	$aboutToolStripMenuItem.Size = '253, 22'
	...
	$flagCheckToolStripMenuItem.Size = '253, 22'
	$flagCheckToolStripMenuItem.Text = 'Flag Check Help'
	...
	$eQCPUAffinityToolStripMenuItem.Size = '253, 22'
	$eQCPUAffinityToolStripMenuItem.Text = 'EQ CPU Affinity Help'
	...
	$buildShortcutsToolStripMenuItem.Size = '253, 22'
	$buildShortcutsToolStripMenuItem.Text = 'Build Shortcuts... Help'
	...
	$buildAutoHotKeyScriptToolStripMenuItem.Size = '253, 22'
	$buildAutoHotKeyScriptToolStripMenuItem.Text = 'Build AutoHotKey Script Help'
	...
	$buildMQ2AutoLoginINIToolStripMenuItem.Size = '253, 22'
	$buildMQ2AutoLoginINIToolStripMenuItem.Text = 'Build MQ2AutoLogin INI Help'
	...
	$buildSampleToonsCSVToolStripMenuItem.Size = '253, 22'
	$buildSampleToonsCSVToolStripMenuItem.Text = 'Build Sample Toons.CSV... Help'
	...
	$eQClinitiniReadOnlyToggleToolStripMenuItem.Size = '253, 22'
	$eQClinitiniReadOnlyToggleToolStripMenuItem.Text = 'EQClinit.ini ReadOnly Toggle Help'
	...
	$taskBarGroupingFixToolStripMenuItem.Size = '253, 22'
	$taskBarGroupingFixToolStripMenuItem.Text = 'TaskBar Grouping Fix Help'
	...
	$firstRunTextToolStripMenuItem.Size = '253, 22'
	$firstRunTextToolStripMenuItem.Text = 'First Run Text Help'
...
AT8E/wH8AT8B/AE/Cw=='))
	...
	$legacyItemsToolStripMenuItem.Size = '253, 22'
	...
	$eQMonitorToolStripMenuItem.Size = '253, 22'
	$eQMonitorToolStripMenuItem.Text = 'EQ Monitor Help'
	$eQMonitorToolStripMenuItem.add_Click($eQMonitorToolStripMenuItem_Click)
	#
	# toolstripseparator1
	#
	$toolstripseparator1.Name = 'toolstripseparator1'
	$toolstripseparator1.Size = '250, 6'
	#
	# changeLogToolStripMenuItem
	#
	$changeLogToolStripMenuItem.Name = 'changeLogToolStripMenuItem'
	$changeLogToolStripMenuItem.Size = '253, 22'
